...
package com.google.ar.core.learners.imar.helpers;
...
public class FirebaseManager {
  ...
  public void getAllAnchors(MyCallback myCallback){

      rootRef.addValueEventListener(new ValueEventListener() {
          @Override
          public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
              Anchor anchor = dataSnapshot.getValue(Anchor.class);
              myCallback.onCallback(anchor);
          }
